...
export const metadata: Metadata = {
  title: "Contact Raffy | Abdullah Mansour",
  description: "Contact Raffy's creator Abdullah Mansour via WhatsApp, email, LinkedIn, or GitHub.",
  keywords: ["Contact Raffy", "Abdullah Mansour", ...site.keywordsEn],
  alternates: { canonical: "/en/contact", languages: { ar: "/contact", en: "/en/contact", "x-default": "/contact" } },
};
  ...
  return (
    <main dir="ltr" className="min-h-screen bg-stone-50 text-stone-950 dark:bg-slate-950 dark:text-slate-50">
      ...
      <section className="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold leading-tight sm:text-5xl">Contact Raffy&apos;s creator</h1>
        <p className="mt-5 text-lg leading-8 text-stone-700 dark:text-slate-300">
          For suggestions, collaboration, consulting, or a conversation about applied AI, accessibility, and digital products.
        </p>
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          <ContactLink icon={<MessageCircle size={20} />} label="WhatsApp" value={creator.phone} href={creator.whatsapp} />
          <ContactLink icon={<Mail size={20} />} label="Email" value={creator.email} href={`mailto:${creator.email}`} />
